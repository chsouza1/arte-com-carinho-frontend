  ...
  return (
    <Link href={`/products/${product.id}`} className="group h-full block">
      <Card className="h-full border border-[#D7CCC8] rounded-sm shadow-sm hover:shadow-md hover:border-[#A1887F] transition-all duration-300 bg-white relative overflow-hidden flex flex-col">
        ...
        <div className="absolute top-0 left-0 w-full h-1 bg-[#FBCFE8] opacity-0 group-hover:opacity-100 transition-opacity z-10"></div>
        ...
        <CardContent className="flex flex-col flex-1 p-5 relative bg-[url('/paper-texture-light.png')]">
          ...
          <div className="mb-2 flex items-center gap-1.5">
            <span className="inline-block w-2 h-2 rounded-full bg-[#FBCFE8]/50 group-hover:bg-[#FBCFE8] transition-colors"></span>
            <span className="text-[10px] font-bold uppercase tracking-widest text-[#8D6E63]">
              {product.category || "Artesanato"}
            </span>
          </div>

          <h3 className="text-lg font-serif font-bold text-[#5D4037] leading-tight line-clamp-2 mb-2 group-hover:text-[#F9A8D4] transition-colors">
            {product.name}
          </h3>
          ...
          <div className="mt-auto pt-4 border-t border-dashed border-[#D7CCC8] flex items-center justify-between">
            ...
            <div className="w-8 h-8 rounded-full bg-[#FAF7F5] border border-[#D7CCC8] flex items-center justify-center text-[#5D4037] group-hover:bg-[#FBCFE8] group-hover:border-[#FBCFE8] group-hover:text-[#5D4037] transition-all shadow-sm">
                <Eye size={16} />
            </div>
          </div>
        </CardContent>
